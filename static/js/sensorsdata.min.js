try {
  !function (sd) {
      ...
      function str(e, t) {
        ...
        switch (c && "object" == typeof c && "function" == typeof c.toJSON && (c = c.toJSON(e)), "function" == typeof rep && (c = rep.call(t, e, c)), typeof c) {
          ...
          case"object":
            ...
            if (rep && "object" == typeof rep)for (o = rep.length, r = 0; o > r; r += 1)"string" == typeof rep[r] && (n = rep[r], i = str(n, c), i && a.push(quote(n) + (gap ? ": " : ":") + i)); else for (n in c)Object.prototype.hasOwnProperty.call(c, n) && (i = str(n, c), i && a.push(quote(n) + (gap ? ": " : ":") + i));
            return i = 0 === a.length ? "{}" : gap ? "{\n" + gap + a.join(",\n" + gap) + "\n" + s + "}" : "{" + a.join(",") + "}", gap = s, i
        }
      }
    ...
    logger.info = function () {
      ...
      var t, r, n, i, o, a, s, c, l = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", d = 0, u = 0,
        f = "", p = [];
      if (!e)return e;
      e = _.utf8Encode(e);
      do t = e.charCodeAt(d++), r = e.charCodeAt(d++), n = e.charCodeAt(d++), c = t << 16 | r << 8 | n, i = c >> 18 & 63, o = c >> 12 & 63, a = c >> 6 & 63, s = 63 & c, p[u++] = l.charAt(i) + l.charAt(o) + l.charAt(a) + l.charAt(s); while (d < e.length);
      ...
      var e = function () {
        ...
        var r, n, i = navigator.userAgent, o = [], a = 0;
        for (r = 0; r < i.length; r++)n = i.charCodeAt(r), o.unshift(255 & n), o.length >= 4 && (a = t(a, o), o = []);
      ...
      function r() {
        var e = document;
        return null != e.pageXOffset ? {x: e.pageXOffset, y: e.pageYOffset} : {
      ...
      function n(t) {
        t = t || window.event;
        var n = r();
        e.style.left = t.clientX + n.x - d + "px", e.style.top = t.clientY + n.y - u + "px", t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0
      }
      ...
      var o = r(), a = t.clientX + o.x, s = t.clientY + o.y, c = e.offsetLeft, l = e.offsetTop, d = a - c, u = s - l;
      document.addEventListener ? (document.addEventListener("mousemove", n), document.addEventListener("mouseup", i)) : document.attachEvent && (document.attachEvent("onmousemove", n), document.attachEvent("onmouseup", i)), t.stopPropagation ? t.stopPropagation() : t.cancelBubble = !0, t.preventDefault ? t.preventDefault() : t.returnValue = !1
      ...
      function e(e, r, n) {
        var i = function (i) {
          if (i = i || t(window.event)) {
            ...
            var o, a, s = !0;
            return _.isFunction(n) && (o = n(i)), a = r.call(e, i), (!1 === o || !1 === a) && (s = !1), s
          }
        };
        return i
      }
      ...
      get: function (e) {
        ...
        if (0 !== r) {
          var l = new Date;
          "s" === String(r).slice(-1) ? l.setTime(l.getTime() + 1e3 * Number(String(r).slice(0, -1))) : l.setTime(l.getTime() + 24 * r * 60 * 60 * 1e3), a = "; expires=" + l.toGMTString()
        }
      ...
      function n(e, r) {
        for (var n = e.charAt(0), i = r.split("&"), o = [], a = {}, s = [], c = e.substring(1), l = 0, d = i.length; d > l; l++)if (o = i[l].match(/(.*?)=(.*)/), o || (o = [i[l], i[l], ""]), "" !== o[1].replace(/\s/g, "")) {
      ...
      initPage: function () {
        var e = _.getReferrer(), t = e ? _.url("hostname", e) : e, r = e ? _.url("domain", e) : e, n = location.href,
          i = n ? _.url("hostname", n) : n, o = n ? _.url("domain", n) : n;
        this.pageProp = {referrer: e, referrer_host: t, referrer_domain: r, url: n, url_host: i, url_domain: o}
    ...
    var heatmap_render = {
      showErrorInfo: function (e, t) {
        ...
        r.setAttribute("style", "background:#e55b41;border:none;border-radius:8px;color:#fff;font-size:18px;left:50%;margin-left:-300px;padding:15px;position: fixed;text-align: center;top: 0;width:600px;z-index:9999;"), 1 === e ? r.innerHTML = "当前页面在所选时间段内暂时没有点击数据" : 2 === e ? t.error ? r.innerHTML = t.error : r.innerHTML = "请求数据异常或者缓存超时" : 3 === e ? r.innerHTML = "当前页面在所选时间段内暂时没有点击数据" : 4 === e && (t.error ? r.innerHTML = t.error : r.innerHTML = "请求数据异常或者缓存超时"), document.body.appendChild(r), setTimeout(function () {
          document.body.removeChild(r)
        }, 5e3)
      }, requestType: 1, getRequestInfo: function (e, t) {
        var r = this;
        if ("string" == typeof e && sd.para.web_url) {
          ...
          i._values.Path = "/api/heat_map/report/path/" + e, t ? (this.requestType = 3, _.ajax({
        ...
        _.each(e, function (e) {
          ...
          if (e.by_values[0]) {
            e.data_page_percent = Number(e.value_fix / i * 100).toFixed(2) + "%", e.data_click_percent = Number(e.value_fix / r * 100).toFixed(2) + "%", e.data_click = Number(e.value_fix / r), e.data_page = Number(e.value_fix / i);
            var a = new _.urlParse(sd.para.web_url);
            a._values.Path = "/web-click/users/#heat_map_id=" + n + "&element_selector=" + encodeURIComponent(e.by_values[0]), e.data_user_link = a.getUrl(), "null" === String(e.top_values[0]) ? e.data_top_value = "没有值" : e.data_top_value = String(e.top_values[0]);
        ...
        var n = _.ry(e[0]);
        n.attr("data-heat-place", String(r)).addClass("sa-click-area").attr("data-click", t.data_click_percent).addClass("sa-click-area" + this.heatData(t.data_click)), "inline" === n.getStyle("display") && (e[0].style.display = "inline-block")
      }, is_fix_state: null, showEffectBox: function (e, t, r) {
        if ("fixslidedown" === this.is_fix_state) t.style.position = "fixed", t.style.left = "auto", t.style.right = 0, t.style.top = 0, r && (t.className = "sa-heat-box-effect-2017314"); else if ("notfix" === this.is_fix_state) {
          var n = heatmap.getBrowserWidth(), i = e.target, o = _.ry(i).offset(), a = _.ry(i).getSize(),
            s = o.left + a.width + 2, c = o.top + 1;
          s + 220 > n && (s = o.left - 220, o.left < 220 && (s = e.pageX)), t.style.position = "absolute", t.style.left = s + "px", t.style.top = c + "px"
        }
        "block" !== t.style.display && (t.style.display = "block")
      }, bindEffect: function () {
        function e(e) {
          r = e;
          var t = e.target, n = t.getAttribute("data-heat-place"), l = i.data_render[n];
          if (!l)return !1;
          var d = _.trim(t.textContent);
          d && (d = d.replace(/[\r\n]/g, " ").replace(/[ ]+/g, " ").substring(0, 255)), l.data_current_content = d || "没有值", a = o.replace(/\{\{[^\{\{]+\}\}/g, function (e) {
            return e = e.slice(2, -2), "string" == typeof e && "object" == typeof l ? l[e] : void 0
          }), f.innerHTML = a, i.showEffectBox(e, c, s)
        }
        ...
        _.addEvent(c, "mouseleave", function () {
          ...
          l.style.display = "block", u.style.display = "none", i.is_fix_state = "notfix", _.cookie.set("sensorsdata_heatmap_float_fix_state", "notfix"), i.showEffectBox(r, c, s)
        }), _.addEvent(h, "click", function (e) {
          u.style.display = "block", l.style.display = "none", i.is_fix_state = "fixslidedown", _.cookie.set("sensorsdata_heatmap_float_fix_state", "fixslidedown"), i.showEffectBox(r, c, s)
        }), _.addEvent(p, "click", function () {
          s = !1, u.style.display = "none", d.style.display = "block", f.style.display = "none", c.style.width = "70px", c.style.height = "30px", i.is_fix_state = "fixslideup", _.cookie.set("sensorsdata_heatmap_float_fix_state", "fixslideup")
        }), _.addEvent(d, "click", function () {
          s = !0, u.style.display = "block", d.style.display = "none", f.style.display = "block", c.style.width = "220px", c.style.height = "auto", i.is_fix_state = "fixslidedown", _.cookie.set("sensorsdata_heatmap_float_fix_state", "fixslidedown")
        }), _.addEvent(c, "animationend", function () {
          c.className = ""
        });
        var v = _.cookie.get("sensorsdata_heatmap_float_fix_state");
        null === v ? this.is_fix_state = "notfix" : this.is_fix_state = v, "notfix" === this.is_fix_state ? (l.style.display = "block", u.style.display = "none", d.style.display = "none") : "fixslidedown" === this.is_fix_state ? (d.style.display = "none", l.style.display = "none", u.style.display = "block") : "fixslideup" === this.is_fix_state && (s = !1, c.style.width = "70px", c.style.height = "30px", f.style.display = "none", d.style.display = "block", l.style.display = "none", u.style.display = "none");
        var b = 600, y = null;
        _.addEvent(document, "mouseover", function (e) {
          var r = e.target, i = r.className;
          return y = r, "string" != typeof i || -1 === (" " + i + " ").indexOf(" sa-click-area ") ? !1 : (r.onmouseleave = function () {
            setTimeout(function () {
      ...
      getDomIndex: function (e) {
        ...
        i.$element_selector = n ? n : "", "a" === r && sd.para.heatmap && sd.para.heatmap.isTrackLink === !0 ? _.trackLink({event: e}, "$WebClick", i) : sd.track("$WebClick", i)
        ...
        return _.isObject(sd.para.heatmap) ? _.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url() ? !1 : ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : "interact" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "interact" : sd.para.heatmap.collect_elements = "interact", void("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click", function (t) {
          var r = t || window.event, n = r.target || r.srcElement, i = n.tagName.toLowerCase();
