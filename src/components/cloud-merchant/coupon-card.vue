<template>
  <div class="coupon-card" :class="{ 'lose-effect': isFailure }">
    ...
    <div class="coupon-title flex-c-m" v-if="isCouponName">礼品券</div>
    ...
    <div class="coupon-suggest">
      <div class="coupon-text">券描述在百联购物中心消费200元可获得免…</div>
    ...
    <div class="coupon-body flex-m">
      ...
      <div class="time coupon-body-item">
        <p class="cate">2016.12.03</p>
        <p>2017.01.01</p>
      </div>
    </div>
    <div class="coupon-bottom flex-c-m" v-if="!isFailure">
